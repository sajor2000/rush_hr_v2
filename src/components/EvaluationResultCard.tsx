...
const tierColorMap: Record<string, { bg: string; text: string; border: string }> = {
  'First Quartile': { bg: 'bg-green-100', text: 'text-green-800', border: 'border-green-500' },
  'Second Quartile': { bg: 'bg-blue-100', text: 'text-blue-800', border: 'border-blue-500' },
  'Third Quartile': { bg: 'bg-yellow-100', text: 'text-yellow-800', border: 'border-yellow-500' },
  'Fourth Quartile': { bg: 'bg-orange-100', text: 'text-orange-800', border: 'border-orange-500' },
  // Legacy support
  ...
  notQualified: { bg: 'bg-orange-100', text: 'text-orange-800', border: 'border-orange-500' },
};
